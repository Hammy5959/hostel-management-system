...
export const navigation: NavEntry[] = [
...

  {
    ...
    data: {
      ...
      icon: Wrench,
      items: [
        { label: "Maintenance Tickets", href: "/maintenance-tickets", icon: Wrench },
        { label: "Inventory Categories", href: "/inventory-categories", icon: FolderTree },
        { label: "Inventory Items", href: "/inventory-items", icon: Package },
        { label: "Assets", href: "/assets", icon: Landmark },
        { label: "Asset Assignments", href: "/asset-assignments", icon: ClipboardList },
      ],
    },
  },
