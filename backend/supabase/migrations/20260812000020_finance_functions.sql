-- ─────────────────────────────────────────────────────────────────────────────
-- HMS — Finance RPC functions.
--
-- hms_record_payment: records a payment against an invoice and atomically
-- updates the invoice balance/status. Over-payment is rejected. Money is
